...
import evaporation from './assets/img/extra.png';
import Chat from './chat';
import Footer from './footer';

const ExtraccionQuimica = () => {
    ...
    <div>
      ...
      <div className="dashboard-containerr">
        ...
        <div className="container">
          ...
          <h1 className="text-2xl font-bold mb-4">Extracción Química</h1>
...
export default ExtraccionQuimica;
